...
int SaveFileBMP( const char* filename, unsigned char* pixels, int width, int height, int pixelSize = 3 );

int SaveFileGrayBMP( const char* filename, unsigned char* pixels, int width, int height );
